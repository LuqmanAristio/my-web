...
export function Contact() {
  ...
  return (
    ...
    >
      ...
      <div 
        className="absolute left-0 md:left-12 top-1/2 -translate-y-1/2 text-[20rem] md:text-[28rem] font-bold text-foreground/[0.02] select-none pointer-events-none leading-none"
        style={{
